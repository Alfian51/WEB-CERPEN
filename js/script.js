    ...
    if (cerpenList) {
        ...
        const displayStories = (stories) => {
            ...
            if (!stories || stories.length === 0) {
                cerpenList.innerHTML = '<p class="col-12">Tidak ada cerpen yang ditemukan.</p>';
                return;
            }
    ...
    if (latestStoriesList) {
        const fetchLatestStories = async () => {
            try {
                ...
                if (!stories || stories.length === 0) {
                    latestStoriesList.innerHTML = '<p class="col-12">Belum ada cerpen yang dipublikasikan.</p>';
                } else {
